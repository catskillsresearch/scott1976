...
MODEL_CARDS: tuple[ModelCard, ...] = (
    ModelCard(
        ...
        cite_key="Cur26",
        tool_note=(
            "agent-assisted editing in the Cursor IDE: formalizing Scott's 1976 "
            "*Data Types as Lattices* in Lean 4 / mathlib, `lake build` repair, vision-OCR "
    ...
    ModelCard(
        ...
        tool_note=(
            ...
            "`Scott1976/DataTypesAsLattices/`, documentation, and medium proof obligations "
